package br.gov.ipem.racdmlf.view;
...
import br.gov.ipem.racdmlf.controller.RacDmlfXMLController;
...
public class FrmInicial extends javax.swing.JFrame {
						...
						.addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(
												jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 372,
								...
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 440,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 436,
														javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		AtomicInteger tipoMsg = new AtomicInteger();
		
		RacDmlfXMLController.lerRegistrosXML(path, () -> {
			msg.append(":) Sucesso");
			tipoMsg.set(JOptionPane.INFORMATION_MESSAGE);
		}, () ->  {
			msg.append(":( Erro");
			tipoMsg.set(JOptionPane.ERROR_MESSAGE);
		});
		
		JOptionPane optionPane = new JOptionPane(msg.toString(), tipoMsg.get());    
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(FrmInicial.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
